<?php
/*
Template Name: Speakers of another conference
*/
get_header();
?>
<div class="container">
...
<div class="selector_block">
      ...
      <ul class="selector">
         ...
         <ul id="myDropdown3" class="dropdown3-content">
           <a href="/speakers-of-wealth-top-forum-israel-2016/"><li>Wealth TOP FORUM Israel 2016</li></a> 
   ...
   <div class="speakers_block">
	...
	'numberposts' => -1,
	'conference'    => 'another-name-of-the-conference',
	'orderby'     => 'date',
	'order'       => 'DESC',
	'post_type'   => 'speaker',
